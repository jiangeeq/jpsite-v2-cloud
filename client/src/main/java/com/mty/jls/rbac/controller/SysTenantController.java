...
public class SysTenantController {
    ...
    @ApiOperation(value = "分页查询")
     public Response getSysTenantPage(Page page, SysTenant sysTenant) {
        return Response.succeed(sysTenantService.page(page, Wrappers.query(sysTenant)));
    }
    ...
    @PostMapping
     public Response save(@RequestBody SysTenant sysTenant) {
    ...
    @PutMapping
     public Response updateById(@RequestBody SysTenant sysTenant) {
