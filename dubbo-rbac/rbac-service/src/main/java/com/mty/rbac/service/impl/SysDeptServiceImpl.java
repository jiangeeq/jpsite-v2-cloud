...
import com.mty.rbac.domain.SysDept;
import com.mty.rbac.dto.DeptDTO;
import com.mty.rbac.mapper.SysDeptMapper;
import com.mty.rbac.util.RbacUtil;
import com.mty.rbac.vo.DeptTreeVo;
...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper, SysDept> implements ISysDeptService {
    ...
    public List<ISysDept> selectDeptList() {
        ...
        ArrayList<ISysDept> iSysDepts = new ArrayList<>();
        BeanUtil.copyProperties(parentDeptList, iSysDepts);
        return iSysDepts;
    }
